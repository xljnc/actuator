...
public class OAuth2Controller {
    ...
    public String welcome(@RequestParam("code") String code, Model model) {
        ...
        String tokenUrl = new StringBuilder("https://gitee.com/oauth/token?grant_type=authorization_code&").append("client_id=xxx")
                .append("&client_secret=xxxx").append("&code=").append(code).append("&redirect_uri=").append("http://localhost:8888/oauth2/welcome").toString();
        Map<String, String> response = oauthFeignClient.post(UriUtil.convert(tokenUrl));
